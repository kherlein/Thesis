...
fireZ <- sfa(log( Daily_Held_noneg ) ~ crew_d + air_d + log(pmax( crewtotal, crew_d)) + log(pmax(airtotal, air_d)) |
                rh_lag + temp_max + agric_wind_max + perc_river + Timber
